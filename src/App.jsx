    ...
    <div className="min-h-screen bg-[#0f172a] text-slate-300 antialiased selection:bg-cyan-500 selection:text-white">
      ...
      <div className="border-b border-slate-800/60 bg-[#0b0f19] py-16 md:py-24">
        <div className="px-4 md:px-8 max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12 justify-between">
          ...
          {/* Sol Taraf: Marka ve Logo Alanı */}
          <div className="flex-1 text-center md:text-left">
            
            {/* Düzenleme: Logo büyütüldü ve ismin önüne yerleştirildi */}
            <div className="flex flex-col md:flex-row items-center gap-5 mb-6 justify-center md:justify-start">
              <div className="w-20 h-20 rounded-full overflow-hidden border-2 border-cyan-500 bg-[#161e2e] shadow-xl shrink-0">
