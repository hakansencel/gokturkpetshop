...
export const pagesData = {
  ...
  birds: { title: "Kuş Çeşitleri", items: ["Muhabbet Kuşu", "Kanarya", "Sultan Papağanı", "Cennet Papağanı", "Sevda Papağanı", "Hint Bülbülü", "Zebra İspinozu", "Forpus Papağanı", "Jako Papağanı", "Güvercin"] },
