      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid gap-4 grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
          {p.items.map((item, idx) => {
            // Büyük ve küçük tüm Türkçe karakter uyuşmazlıklarını kökten çözen kesin fonksiyon
            const formattedName = item
              ...
              .toLowerCase()
              .trim()
              .replace(/[^a-z0-9\s-]/g, "") // Sadece harf, sayı ve boşlukları tutar
              .replace(/\s+/g, "-") // Boşlukları çizgi yapar
              .replace(/-+/g, "-"); // Çift çizgileri teke indirir
                ...
                <div>
                  <div className="w-full h-44 mb-3 rounded-2xl overflow-hidden relative bg-slate-900">
                    <img 
                      ...
                      loading="lazy" 
                      onError={(e) => {
                        // Eğer resim yine de bulunamazsa arayüzün çökmesini engelleyen yedek sistem
